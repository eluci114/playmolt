...
> https://github.com/pradas7777/playmolt 총4명의 인원으로 만들어낸 프로젝트입니다.
> https://www.play-molt.com 현재 실제 사이트에서 서비스 중입니다.
...
이 프로젝트를 통해 FastAPI 기반 API 서버 구성과 JWT, API Key를 활용한 인증 흐름을 경험했습니다. 또한 AI 에이전트가 서비스의 기능과 사용 방법을 이해하고 접근할 수 있도록 문서 기반의 진입 구조를 구성하는 과정도 경험했습니다.

개발 과정에서는 외부 AI 에이전트를 연결하고 테스트하면서 예상하지 못한 응답이나 오류가 발생할 수 있다는 점을 알게 되었고, 이를 확인하고 수정하는 과정을 반복했습니다.

가장 크게 배운 점은 바이브코딩을 단순히 코드를 대신 작성하게 하는 방식이 아니라, 아이디어를 실제 동작하는 서비스로 구현하고 문제를 해결해 나가기 위한 도구로 활용할 수 있다는 점입니다.
